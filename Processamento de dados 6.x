...
scp42 <- read.table(paste("A:/OneDrive - Instituto Superior de Engenharia do Porto/Doutoramento/Heuristicas/R/Meta-RaPS/SCP-Instances/scp6",SaveFile,".txt",sep=""), sep = "", header = FALSE, fill = T) 
#scp42 <- read.table("A:/OneDrive - Instituto Superior de Engenharia do Porto/Doutoramento/Heuristicas/R/Meta-RaPS/SCP-Instances/scp61.txt", sep = "", header = FALSE, fill = T) 
...
scp42Att <- scp42A[1:2,]
scp42Att[2,13:48] <- c(scp42A[3,],scp42A[4,],scp42A[5,])
scp42Att[2,49:72] <- NA


for (i in 6:nrow(scp42A)){
  
  if (       scp42A[i,1]>max(scp42A[i-1,],na.rm=T)  &&  is.na(scp42A[i-5,12])==FALSE  &&  is.na(scp42A[i-4,12])==FALSE  &&  is.na(scp42A[i-3,12])==FALSE  &&  is.na(scp42A[i-2,12])==FALSE  &&  is.na(scp42A[i-1,12])==FALSE  &&  is.na(scp42A[i-6,12])==TRUE){
    scp42Att[i-4,61:72] <- scp42A[i,]
  } else if (scp42A[i,1]>max(scp42A[i-1,],na.rm=T)  &&  is.na(scp42A[i-4,12])==FALSE  &&  is.na(scp42A[i-3,12])==FALSE  &&  is.na(scp42A[i-2,12])==FALSE  &&  is.na(scp42A[i-1,12])==FALSE  &&  is.na(scp42A[i-5,12])==TRUE){
    scp42Att[i-4,49:60] <- scp42A[i,]
  } else if (scp42A[i,1]>max(scp42A[i-1,],na.rm=T)  &&  is.na(scp42A[i-3,12])==FALSE  &&  is.na(scp42A[i-2,12])==FALSE  &&  is.na(scp42A[i-1,12])==FALSE  &&  is.na(scp42A[i-4,12])==TRUE){
    scp42Att[i-3,37:48] <- scp42A[i,]
  } else if (scp42A[i,1]>max(scp42A[i-1,],na.rm=T)  &&  is.na(scp42A[i-2,12])==FALSE  &&  is.na(scp42A[i-1,12])==FALSE  &&  is.na(scp42A[i-3,12])==TRUE){
...
save.image(file = paste("X6",SaveFile,".RData",sep = ""))
